...
const {
  populateLang,
  updateLang,
} = require('./language/language.controller');
const {
  populateZip,
  updateZip,
} = require('./zip/zip.controller');
const {
  populateOffice,
  updateOffice,
} = require('./office/office.controller');
const {
  populateNav,
  updateNav,
} = require('./navigation/navigation.controller');

const config = require('./config/config');
const wpConfig = require('../config/webpack.config');
const App = require('../client/js/components/App').default;
